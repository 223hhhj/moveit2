...
class UDPPublisherNode(Node):
    def __init__(self):
        ...
        self.acceleration_publisher_ = self.create_publisher(Float64, 'acceleration_control', 10)  # New publisher
    ...
    def timer_callback(self):
        ...
        self.acceleration_publisher_.publish(acceleration_msg)
        ...
        self.get_logger().info(f'Calculated acceleration: {acceleration:.4f}')
