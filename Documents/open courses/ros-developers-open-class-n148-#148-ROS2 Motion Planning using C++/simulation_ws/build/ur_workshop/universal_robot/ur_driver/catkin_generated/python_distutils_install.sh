...
echo_and_run cd "/home/user/simulation_ws/src/ur_workshop/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/user/simulation_ws/src/ur_workshop/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/user/simulation_ws/build/ur_workshop/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
