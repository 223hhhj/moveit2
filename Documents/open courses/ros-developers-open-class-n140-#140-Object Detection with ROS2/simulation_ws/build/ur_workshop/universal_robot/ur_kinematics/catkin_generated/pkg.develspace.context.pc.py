...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/home/user/simulation_ws/src/ur_workshop/universal_robot/ur_kinematics/include;/usr/include".split(';') if "/home/user/simulation_ws/src/ur_workshop/universal_robot/ur_kinematics/include;/usr/include" != "" else []
