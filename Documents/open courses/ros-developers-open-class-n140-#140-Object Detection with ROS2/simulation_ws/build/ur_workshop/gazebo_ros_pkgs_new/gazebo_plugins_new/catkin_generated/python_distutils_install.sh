...
echo_and_run cd "/home/user/simulation_ws/src/ur_workshop/gazebo_ros_pkgs_new/gazebo_plugins_new"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/user/simulation_ws/src/ur_workshop/gazebo_ros_pkgs_new/gazebo_plugins_new/setup.py" \
     \
    build --build-base "/home/user/simulation_ws/build/ur_workshop/gazebo_ros_pkgs_new/gazebo_plugins_new" \
    install \
    --root="${DESTDIR-/}" \
