...
#include "grasping_msgs/msg/detail/graspable_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const grasping_msgs::msg::GraspableObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<grasping_msgs::msg::GraspableObject *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GraspableObject__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const grasping_msgs::msg::GraspableObject *>(
...
{
  return max_serialized_size_GraspableObject(full_bounded, 0);
}

static message_type_support_callbacks_t _GraspableObject__callbacks = {
  "grasping_msgs::msg",
  "GraspableObject",
...
static rosidl_message_type_support_t _GraspableObject__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GraspableObject__callbacks,
...
{
  return &grasping_msgs::msg::typesupport_fastrtps_cpp::_GraspableObject__handle;
}
