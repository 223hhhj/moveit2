...
bool grasping_msgs__msg__graspable_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("grasping_msgs.msg._graspable_object.GraspableObject", full_classname_dest, 51) == 0);
  }
  grasping_msgs__msg__GraspableObject * ros_message = _ros_message;
  {  // object
...
{
  /* NOTE(esteve): Call constructor of GraspableObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("grasping_msgs.msg._graspable_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GraspableObject");
