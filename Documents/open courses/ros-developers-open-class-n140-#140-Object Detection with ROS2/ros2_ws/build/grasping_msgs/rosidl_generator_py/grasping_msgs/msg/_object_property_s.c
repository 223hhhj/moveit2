...
bool grasping_msgs__msg__object_property__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("grasping_msgs.msg._object_property.ObjectProperty", full_classname_dest, 49) == 0);
  }
  grasping_msgs__msg__ObjectProperty * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of ObjectProperty */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("grasping_msgs.msg._object_property");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectProperty");
